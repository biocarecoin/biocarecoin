...
{
    const char* pszTimestamp = "On 14/5/2021 Musk Renews Critique of Bitcoin Talks Up Dogecoin";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("c9601930ec2cfb184977dc73ea7ccb8d6d6ed6b8882d50981f4caaf25362b18b");
        ...
        consensus.defaultAssumeValid = uint256S("54040b5749be8d309fa0de3a1d01dcf1ca1c82c10ee5e165cd533b736e84f125"); //1683528
        ...
        genesis = CreateGenesisBlock(1621101448, 1125, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("54040b5749be8d309fa0de3a1d01dcf1ca1c82c10ee5e165cd533b736e84f125"));
        assert(genesis.hashMerkleRoot == uint256S("d28109d0a47984ec1b10dd41aa852e30e57f8b8d1cb5ba127d29d836ce294655"));
        ...
        checkpointData = {
            {
                {  0, uint256S("54040b5749be8d309fa0de3a1d01dcf1ca1c82c10ee5e165cd533b736e84f125")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("54040b5749be8d309fa0de3a1d01dcf1ca1c82c10ee5e165cd533b736e84f125"); //1174621
        ...
        //vSeeds.emplace_back("testnet-seed.biocarecointools.com");
        //vSeeds.emplace_back("seed-b.biocarecoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("54040b5749be8d309fa0de3a1d01dcf1ca1c82c10ee5e165cd533b736e84f125");
