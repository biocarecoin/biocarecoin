...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " biocarecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  biocarecoin-tx [options] <hex-tx> [commands]  Update hex-encoded biocarecoin transaction\n" +
            "or:     biocarecoin-tx [options] -create [commands]   Create hex-encoded biocarecoin transaction\n" +
            "\n";
