# Support for Output Descriptors in Biocarecoin Core

Since Biocarecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Biocarecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Biocarecoin Core wallets, a convenience function `combo` is
