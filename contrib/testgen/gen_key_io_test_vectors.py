...
bech32_templates = [
  ...
  ('bcr',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('bcr',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('bcr',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
