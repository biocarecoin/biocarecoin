...
"""Verify that starting biocarecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start biocarecoin with -h for help text")
        ...
        self.log.info("Start biocarecoin with -version for version information")
        ...
        self.log.info("Start biocarecoind with -fakearg to make sure it does not start")
